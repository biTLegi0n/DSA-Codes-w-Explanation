...
/**
 * @brief   In order to solve this one, we take the reverse of the string, and append it at the back of the original string, and now, find its 
...
protected:
    string zfunction(string &s, vector <int>&pi,int k){
        ...
        for(int i = 1, l=0, r=  0; i<n; i++){
            ...
            // this condition is for question, above code is for pi[]/z
            if(i+pi[i]==n){
